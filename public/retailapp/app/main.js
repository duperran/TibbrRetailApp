...
require([
    ...
    //'bootstrap'
       ...
       // Indeed we resize the parent iFrame When entering in the app to handle the different DIV Height specified in Items, Explore, Home ...
        ...
        tib.src =  '/retailapp/app/js/lib/tibbr.js';
       ...
       bootstrap.src =  '/retailapp/app/js/lib/bootstrap/js/bootstrap.js';
       document.body.appendChild(bootstrap);
          
       var jqueryui = document.createElement('script');
       jqueryui.type = 'text/javascript';
       jqueryui.src =  '/retailapp/app/js/lib/jquery-ui-1.10.3/js/jquery-ui-1.10.3.custom.js';
